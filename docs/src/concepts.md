...
**ClientApp**: Most common. For bots handling multiple users/channels. Runs one shard at a time - if reconnect is enabled and a shard fails, it switches to the next available shard.
